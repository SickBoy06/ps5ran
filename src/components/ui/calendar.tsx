    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-slate-800 border-slate-700 p-0 hover:bg-slate-700"
        ),
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 text-slate-300 hover:text-slate-100"
        ),
        day_range_end: "day-range-end",
        day_selected:
          "bg-blue-600 text-slate-50 hover:bg-blue-700 hover:text-slate-50 focus:bg-blue-700 focus:text-slate-50",
        day_today: "bg-slate-800 text-slate-100",
        day_outside:
          "day-outside text-slate-500 opacity-50 aria-selected:bg-slate-800/50 aria-selected:text-slate-300 aria-selected:opacity-30",
